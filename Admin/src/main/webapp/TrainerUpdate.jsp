...
<head>
    ...
    <!-- Avoid using Bootstrap with Tailwind to prevent conflicts -->
</head>
<body>
  ...
  <path fill="black" d="M12 2C10.34 2 9 3.34 9 5C9 6.66 10.34 8 12 8C13.66 8 15 6.66 15 5C15 3.34 13.66 2 12 2M19 22V19C19 17.34 17.66 16 16 16H8C6.34 16 5 17.34 5 19V22H19M12 10C7.58 10 4 13.58 4 18H2C2 12.48 6.48 8 12 8S22 12.48 22 18H20C20 13.58 16.42 10 12 10Z"/>
    ...
    <!-- Trainer Update Form -->
    <section class="max-w-4xl mx-auto mt-10 bg-white p-6 shadow-md dark:bg-gray-700">
        <h2 class="text-lg font-semibold text-gray-700 dark:text-white">Trainer Update</h2>
        <form action="TrainerUpdateServlet" method="post" >
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-4">
                <!-- Input Fields with Validation -->
                <div>
                    <label for="username" class="text-gray-700 dark:text-gray-200">Username:</label>
                    <input id="username" name="username" type="text" class="block w-full px-4 py-2" required>
                </div>
                <div>
                    <label for="emailAddress" class="text-gray-700 dark:text-gray-200">Email Address:</label>
                    <input id="emailAddress" name="emailAddress" type="email" class="block w-full px-4 py-2" required>
                </div>
                <div>
                    <label for="phone" class="text-gray-700 dark:text-gray-200">Phone:</label>
                    <input id="phone" name="phone" type="tel" class="block w-full px-4 py-2" pattern="[0-9]{10}" required>
                </div>
                <div>
                    <label for="gender" class="text-gray-700 dark:text-gray-200">Gender:</label>
                    <select id="gender" name="gender" class="block w-full px-4 py-2" required>
                ...
                <div>
                    <label for="aadhar_no" class="text-gray-700 dark:text-gray-200">Aadhar No:</label>
                    <input id="aadhar_no" name="aadhar_no" type="text" class="block w-full px-4 py-2" required>
                </div>
                <div>
                    <label for="experience" class="text-gray-700 dark:text-gray-200">Experience (years):</label>
                    <input id="experience" name="experience" type="number" class="block w-full px-4 py-2" required>
                </div>
                <div>
                    <label for="age" class="text-gray-700 dark:text-gray-200">Age:</label>
                    <input id="age" name="age" type="number" class="block w-full px-4 py-2" required>
                </div>
                <div>
                    <label for="certified_trainer" class="text-gray-700 dark:text-gray-200">Certified Trainer:</label>
                    <select id="certified_trainer" name="certified_trainer" class="block w-full px-4 py-2">
                ...
                <!-- New CV Upload Field -->
                <div>
                    <label for="cv" class="text-gray-700 dark:text-gray-200">Upload CV:</label>
                    <input id="cv" name="cv" type="file" class="block w-full px-4 py-2" accept=".pdf,.doc,.docx">
                </div>
            </div>

            <div class="flex justify-end mt-6">
                <button type="submit" class="px-6 py-2 text-white bg-gray-700 rounded-md hover:bg-gray-600">Submit</button>
            </div>
        </form>
    </section>
