...
<body>
  ...
  <path fill="black" d="M12 2C10.34 2 9 3.34 9 5C9 6.66 10.34 8 12 8C13.66 8 15 6.66 15 5C15 3.34 13.66 2 12 2M19 22V19C19 17.34 17.66 16 16 16H8C6.34 16 5 17.34 5 19V22H19M12 10C7.58 10 4 13.58 4 18H2C2 12.48 6.48 8 12 8S22 12.48 22 18H20C20 13.58 16.42 10 12 10Z"/>
			...
			<!-- 	Tab Links -->
                        ...
                        <a href="TrainerUpdate.jsp" class="mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-900 dark:hover:text-gray-200">Trainer Updates</a>
                        ...
                        <a href="RegisterUser.jsp" class="mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-900 dark:hover:text-gray-200">Register User</a>
						<a href="Feedback.jsp" class="mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-900 dark:hover:text-gray-200">Feedbacks</a>
						

                        
        
                        <div class="relative mt-4 lg:mt-0 lg:mx-4">
                           <a href="LogoutAdmin"class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Logout
