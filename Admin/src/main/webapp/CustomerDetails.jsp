...
<%@ page import="java.sql.*" %>
 <div class="container mx-auto p-4">
    ...
    <thead class="bg-gray-200 text-gray-600">
        <tr>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Email</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Name</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Phone</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Address</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Gym</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Training</th>
            <th class="px-6 py-3 text-left border-b-2 border-gray-300">Gender</th>
        </tr>
    </thead>
