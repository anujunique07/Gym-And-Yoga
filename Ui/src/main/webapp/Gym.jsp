...
<body>
      ...
      <header class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <div class="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Gym Training</h1>
      
              <p class="mt-1.5 text-sm text-gray-500">
                You can Apply our gym for Normal or Personal Training and Online or Offline both mode available! 
              </p>
            </div>
  ...
  >
    ...
    />
            ...
            <a href="ApplyNow.jsp" class="inline-block rounded bg-indigo-900 px-5 py-3 text-sm font-medium text-white transition hover:bg-indigo-700 focus:outline-none focus:ring"
              role="button">
              Apply Now
              </a>
          ...
          <div class="flex flex-wrap md:-m-2 -m-1">
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-1/2">
                <img alt="gallery" class="w-full object-cover h-full object-center block" src="Assets/img/Workout5.jpg">
              </div>
              <div class="md:p-2 p-1 w-1/2">
                <img alt="gallery" class="w-full object-cover h-full object-center block" src="Assets/img/Workout6.avif">
              </div>
              <div class="md:p-2 p-1 w-full">
                <video 
                alt="gallery" 
                class="w-full h-full object-cover object-center block" 
                src="Assets/Video/Workout1.mp4" 
                autoplay 
                loop 
                muted
                playsinline>
            ...
            <div class="flex flex-wrap w-1/2">
              <div class="md:p-2 p-1 w-full">
                ...
                alt="gallery" 
                class="w-full h-full object-cover object-center block" 
                src="Assets/Video/Workout2.webm" 
                autoplay 
                loop 
                muted
                playsinline>
              ...
              <div class="md:p-2 p-1 w-1/2">
                <img alt="gallery" class="w-full object-cover h-full object-center block" src="Assets/img/Workout7.webp">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap -m-4">
          <div class="lg:w-1/3 sm:w-1/2 p-4">
            <div class="flex relative">
              <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="Assets/img/Workout1.jpg">
          ...
          <div class="lg:w-1/3 sm:w-1/2 p-4">
            <div class="flex relative">
              <video alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="Assets/Video/Workout3.webm" 
              autoplay 
              loop 
              muted
              playsinline>
          ...
          <div class="lg:w-1/3 sm:w-1/2 p-4">
            <div class="flex relative">
              <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="Assets/img/Workout2.jpg">
          ...
          <div class="lg:w-1/3 sm:w-1/2 p-4">
            <div class="flex relative">
              <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="Assets/img/Workout3.jpg">
              <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
          ...
          <div class="lg:w-1/3 sm:w-1/2 p-4">
            <div class="flex relative">
              <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="Assets/img/Workout4.jpg">
              <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                <h2 class="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">Force & Fitness</h2>
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
            ...
            <video alt="gallery" class="absolute inset-0 h-full w-full object-cover" src="Assets/Video/Workout3.webm" 
            autoplay 
            loop 
            muted
            playsinline>
          ...
          <div class="lg:py-24">
            <h2 class="text-3xl font-bold sm:text-4xl">Take Your Fitness to the Next Level</h2>
    
            <p class="mt-4 text-gray-600">
              Join us at GymFit to transform your body and mind. Whether you're a beginner or a fitness enthusiast, our gym offers personalized training, state-of-the-art equipment, and a supportive community. Start your fitness journey today and see the results you've been waiting for.
            </p>
    ...
    <section class="text-gray-600 body-font">
      <div class="container  mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
          ...
          <video alt="gallery" class="object-cover object-center w-full h-full" src="Assets/Video/Workout4.webm" 
          autoplay 
          loop 
          muted
          playsinline>
